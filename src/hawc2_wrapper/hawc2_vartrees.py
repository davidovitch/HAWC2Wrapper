...
class HAWC2Aero(VariableTree):
    ...
    atef_Ais = Array([0.0, 0.0, 0.0], desc='indicial response parameters for ATEFlap  - As')                               
    atef_Bis = Array([0.0, 0.0, 0.0], desc='indicial response parameters for ATEFlap  - Bs')                             
